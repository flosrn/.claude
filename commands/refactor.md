---
description: Refactor code by finding files, grouping them, and launching parallel Snipper agents. Use for "refactor all X", "rename everywhere", "change pattern across codebase", mass updates. Much faster than sequential edits.
