...
description: Complete Next.js 16 migration guide with breaking changes and upgrade steps. ALWAYS use when the user mentions "upgrade Next.js", "migrate to Next 16", "Next.js 15 to 16", "breaking changes Next.js", "proxy.ts", "middleware migration", "Node.js 20", or asks about upgrading their Next.js version. Covers all breaking changes, codemods, and migration checklist.
---
