...
description: Expert guidance for creating Claude Code slash commands. ALWAYS use when the user says "create a command", "new slash command", "custom command", "créer une commande", "/commands folder", or wants to automate workflows with reusable commands. Covers YAML frontmatter, argument handling, allowed-tools, and command best practices.
---
