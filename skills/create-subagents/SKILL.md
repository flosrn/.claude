...
description: Expert guidance for creating Claude Code subagents (Task tool). ALWAYS use when the user says "create an agent", "new subagent", "custom agent", "créer un agent", "Task tool", or wants to build specialized autonomous agents. Covers agent markdown format, tool restrictions, prompting patterns, and parallel agent execution.
---
